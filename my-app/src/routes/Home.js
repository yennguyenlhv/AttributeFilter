...
export const Home = () => (
    <div>
        ...
        <ExampleWithSource
            ...
            source={AttributeFilterComponentSRC}
        />        
        ...
        <ExampleWithSource
            for={DateFilter}
            source={DateFilterSRC}
        />
        <h2 id="column-chart">Column Chart</h2>
        <ExampleWithSource
            for={PPComparition}
            source={PPComparitionSRC}
        />
        <h2 id="column-chart">Column Chart</h2>
        <ExampleWithSource
        ...
        <ExampleWithSource
            for={DrillSimpleExample}
            source={DrillSimpleExampleSRC}
        />

        <h2 id="column-chart">Re drill</h2>
        <ExampleWithSource
            for={AppAttributeFilter}
            source={AppAttributeFilterSRC}
        />
         */}
        </div>
);
